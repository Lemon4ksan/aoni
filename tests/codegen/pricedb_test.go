...
`
	...
	require.Contains(t, codeStr, "func NewPriceDB(doer aoni.RequestDoer, opts ...aoni.ClientOption) PriceDB")
	require.Contains(t, codeStr, "qBytes = urlutil.AppendQueryEscapeString(qBytes, q)")
