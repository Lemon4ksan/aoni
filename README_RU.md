...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Задержка GET JSON (`ns/op`)** | 58 393 ns | 56 669 ns | 14 127 ns | **5 703 ns** | **В ~10 раз быстрее** |
...
| **Параллельная задержка (`ns/op`)** | 11 307 ns | 9 534 ns | 1 940 ns | **589.9 ns** | **В ~19 раз быстрее в параллель** |
