...
- [ao](https://github.com/Lemon4ksan/ao): Клиентская утилита и библиотека на C/Go на базе `libaoni` (`lib/aoni_bridge.c`). Поддерживает профили TLS uTLS (JA4), гибридный обмен ключами ML-KEM-768 и многопоточный режим работы.
