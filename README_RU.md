...
| **Пиковая пропускная способность** | ~35k RPS | ~30k RPS | >80 000 RPS | **2 146 709+ RPS** | **Экстремальный I/O** |
