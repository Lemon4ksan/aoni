...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: |
| **Анмаршалинг GET JSON Zero-Copy (`JSONNoCopy`)** | 127 905 ns | 54 824 ns | 10 948 ns | 3 542 ns | **2 980 ns** | **⚡ В 42.9 раз быстрее (2.9 мкс, 0 B, 0 allocs)** |
| **Анмаршалинг GET JSON Standard (`GetTo[T]`)** | 127 905 ns | 54 824 ns | 10 948 ns | 5 407 ns | **4 620 ns** | **⚡ В 27.6 раз быстрее (Native) / в 11.6 раз (Bridge)** |
| **Чистое исполнение (`c.Request`)** | 7 002 ns | 6 167 ns | 5 500 ns | 4 011 ns | **3 140 ns** | **⚡ В 2.2 раза быстрее / абсолютный 0-alloc** |
| **Загрузка Multipart Form** | 273 999 ns | — | — | 102 539 ns | **89 400 ns** | **⚡ В 3.1 раза быстрее / в 17 раз меньше RAM (32KB vs 546KB)** |
| **Память в куче (`B/op`)** | 6 990 B | 6 165 B | 5 928 B | 51 B – 362 B | **0 B – 51 B** | **⚡ Абсолютный 0 B (Scoped Borrow) / в 140 раз легче** |
| **Аллокации (`allocs/op`)** | 78 allocs | 68 allocs | 48 allocs | 2 – 8 allocs | **0 – 2 allocs** | **⚡ 0 аллокаций (Scoped Borrow) / -78 аллокаций** |
...
| :--- | :---: | :---: | :---: |
| **Чистый GET (`c.Request` + дренаж тела)** | 16 810 ns / 5 840 B / **67 allocs** | **16 500 ns** / 6 165 B / **68 allocs** | **Быстрее стандартной библиотеки (-310 ns, ~16.5 мкс)** |
| **Обобщённый GET + JSON decode (`request.GetTo[T]`)** | 18 030 ns / 6 770 B / **74 allocs** | **21 664 ns** / 10 772 B / **81 allocs** | +7 аллокаций (Полная диагностика и перехват ответов) |
