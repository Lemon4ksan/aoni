...
func (c *CmdProto) Usage() string     { return "vortex proto [flags]" }
...
func (c *CmdProto) Run(ctx context.Context, args []string, stdout, stderr io.Writer) error {
	...
	fs.Usage = func() {
		fmt.Fprintf(stderr, "vortex proto — Protobuf & Zero-Allocation Codec Toolchain\n\n")
		fmt.Fprintf(stderr, "Usage:\n")
		fmt.Fprintf(stderr, "  vortex proto -src=<proto_dir> -out=<go_dir> -import=<pkg_path> [-vtproto]\n\n")
