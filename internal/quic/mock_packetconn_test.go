...
//
//	mockgen -typed -package quic -self_package github.com/lemon4ksan/aoni/internal/quic -self_package github.com/lemon4ksan/aoni/internal/quic -destination mock_packetconn_test.go net PacketConn
//
