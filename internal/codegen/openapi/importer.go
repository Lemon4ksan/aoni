...
func GenerateSplitContract(spec *openapi3.T, cfg ImportConfig) (apiSource, modelsSource []byte, err error) {
	...
	apiBuf.WriteString("// Code generated by vortex. DO NOT EDIT.\n")
	apiBuf.WriteString("// versions:\n")
	apiBuf.WriteString("// \tvortex v0.6.0\n")
	if cfg.SpecFile != "" {
		fmt.Fprintf(&apiBuf, "// source: %s\n", cfg.SpecFile)
	}
	apiBuf.WriteString("\n")
	...
	if spec.Components != nil && len(spec.Components.Schemas) > 0 {
		...
		modelsBuf.WriteString("// Code generated by vortex. DO NOT EDIT.\n")
		modelsBuf.WriteString("// versions:\n")
		modelsBuf.WriteString("// \tvortex v0.6.0\n")
		if cfg.SpecFile != "" {
			fmt.Fprintf(&modelsBuf, "// source: %s\n", cfg.SpecFile)
		}
