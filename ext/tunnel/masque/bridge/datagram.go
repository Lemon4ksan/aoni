...
import (
	...
	"github.com/lemon4ksan/aoni/ext/tunnel/masque"
	"github.com/lemon4ksan/aoni/ext/tunnel/masque/route"
	"github.com/lemon4ksan/aoni/ext/tunnel/tun"
)
...
func TUNDatagram(
	...
	if session == nil {
		return errors.New("aoni/masque: nil masque session")
	}
