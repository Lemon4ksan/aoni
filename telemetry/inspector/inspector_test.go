...
func TestInspector_HTTPHandlers(t *testing.T) {
	t.Parallel()
	...
	resp := &http.Response{StatusCode: http.StatusOK, Status: "200 OK", ContentLength: 100}

	insp.Capture(req, resp, nil, &telemetry.TraceInfo{})
