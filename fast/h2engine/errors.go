...
var (
	...
	ErrWrongPreface           = errors.New("h2engine: invalid connection preface")
	ErrMalformedString        = errors.New("h2engine: malformed HPACK string data")
	ErrGoAwayRetryable        = errors.New("h2engine: stream affected by GOAWAY frame")
