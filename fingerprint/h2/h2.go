...
//
// Standard Go HTTP/2 transports serialize SETTINGS frames and pseudo-headers in predictable sequences,
// exposing clients to WAF detection. This package intercepts the HTTP/2 connection preface to replace
// default frames with browser-matched parameters (e.g. Chrome, Firefox) and re-encodes HPACK header blocks.
package h2
